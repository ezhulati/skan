...
export const iconMap: Record<string, IconType> = {
  ...
  'analytics': Icons.MdBarChart,
  'orders': Icons.MdListAlt,
  'customers': Icons.MdPeople,
  'inventory': Icons.MdInventory,
  'reports': Icons.MdAssessment,
  ...
  'notification': Icons.MdNotifications,
